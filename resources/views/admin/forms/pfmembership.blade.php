            ...
            <div class="default-tab">
                ...
                <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                            ...
                            <tbody>
                                @isset($form)
                                    ...
                                    <tr class="tr-shadow" style="font-size: 12px; padding: 5px;">
                                        ...
                                        <td><a target="_blank" href="{{route('pfmembershipindividual', $submitted->id)}}"><i class="fa fa-print"></i></a></td>
                                    </tr>
                                    @endforeach
                                @endisset
                            </tbody>
                    ...
                    <div class="tab-pane fade" id="nav-reports" role="tabpanel" aria-labelledby="nav-reports-tab">
                        <form method="POST" action="{{route('pfmembership_print')}}" target="_blank" enctype="multipart/form-data" style="font-size: 12px;">
                            {{csrf_field()}}
                            <div class="row">
                            <!-- <div class="col-md-3">
