            ...
            <div class="default-tab">
                ...
                <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-reports" role="tabpanel" aria-labelledby="nav-reports-tab">
                        <form method="POST" action="{{route('forms.stud_profile_print')}}" target="_blank" enctype="multipart/form-data" style="font-size: 12px;">
                            {{csrf_field()}}
                            <div class="row">
                            <!-- <div class="col-md-3">
                        ...
                        <div id="canvasheader" class="au-card-inner"><div class="chartjs-size-monitor" style="position: absolute; inset: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;">
