...
@section('content')
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4">
            <form method="POST" action="{{route('forms.evaluationactivity_update', $activity->id)}}" enctype="multipart/form-data" style="font-size: 12px;">
              {{csrf_field()}}
              ...
              <div class="form-group">
                  ...
                  <input type="text" id="company" class="form-control" name="title" aria-required="true" aria-invalid="false" data-validation="required" value="{{$activity->title}}">
              </div>

              <div class="form-group">
                  <label class=" form-control-label">Facilitators <span style="color: red; font-weight: bold;">*</span></label>
                  <input type="text" id="company" class="form-control" name="facilitators" aria-required="true" aria-invalid="false" data-validation="required" value="{{$activity->facilitators}}">
              </div>

              <div class="form-group">
                  <label class=" form-control-label">Date <span style="color: red; font-weight: bold;">*</span></label>
                  <input type="date" class="form-control" name="date" aria-required="true" aria-invalid="false" data-validation="required" value="{{$activity->date}}">
              </div>
