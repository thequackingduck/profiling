  ...
  <div class="container p-t-30">
    <div class="card">
        <div class="card-header">
            <p class="cambria" style="font-size: 15px;"><b>Activity: </b>{{$activity->title}} <b style="padding-left: 15px;">Facilitators: </b> {{$activity->facilitators}} <b style="padding-left: 15px;">Date: </b> {{$activity->date}}</p>
        </div>
        <div class="card-body">
            <div class="default-tab">
                ...
                <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                            ...
                            <tbody>
                                @isset($form)
                                    ...
                                    <tr class="tr-shadow" style="font-size: 12px; padding: 5px;">
                                        ...
                                        <td><a target="_blank" href="{{route('evaluationindividual', $submitted->id)}}"><i class="fa fa-print"></i></a></td>
                                    </tr>
                                    @endforeach
                                @endisset
                            </tbody>
                    ...
                    <div class="tab-pane fade" id="nav-reports" role="tabpanel" aria-labelledby="nav-reports-tab">
                        <form method="POST" action="{{route('evaluation_print')}}" target="_blank" enctype="multipart/form-data" style="font-size: 12px;">
                            {{csrf_field()}}
